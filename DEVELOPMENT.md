...
```bash
git remote add encore encore://automated-data-enrichment-platform-r6fi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/automated-data-enrichment-platform-r6fi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/automated-data-enrichment-platform-r6fi/settings/integrations/github)
